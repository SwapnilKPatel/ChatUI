...
class ChatModel: NSObject {
    ...
    func getMessages()-> [ChatModel] {
        ...
        chat1.text = "This is very first message"
        chat1.isIncoming = true
        chat1.date = Date.dateFromCustomString(customString: "07/04/2019 06:30 am")
        ...
        chat2.date = Date.dateFromCustomString(customString: "07/04/2019 12:30 pm")
        ...
        chat3.date = Date.dateFromCustomString(customString: "09/15/2019 06:30 am")
        ...
        chat5.date = Date.dateFromCustomString(customString: "09/16/2019 09:00 pm")
        
        let chat6 : ChatModel = ChatModel()
        chat6.text = "Third Section message"
        chat6.isIncoming = true
        chat6.date = Date.dateFromCustomString(customString: "10/31/2019 04:00 am")
        ...
        chat7.date = Date.dateFromCustomString(customString: "11/15/2019 06:45 am")
